...
@section('title')
    @lang('Profit Return Schedule')
@endsection

@section('content')

    <div class="bd-callout bd-callout-warning m-0 m-md-4 my-4 m-md-0">
        <i class="fas fa-info-circle mr-2 text-warning"></i> You can now set how often you will return the profits to the investors. If you want to give daily profit return to your investors then create 1 day schedule. And select 1 day while <a href="{{ route('admin.propertyCreate') }}" target="_blank">creating investment property.</a>. Then your investors will get daily profit return
    </div>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        ...
        <div class="card-body">
            ...
            <button class="btn btn-sm  btn-primary btn-rounded float-right mb-2 ml-3" type="button"
                    data-toggle="modal"
