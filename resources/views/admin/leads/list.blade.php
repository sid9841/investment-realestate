...
@section('content')
            ...
            @if(adminAccessRoute(config('role.manage_user.access.edit')))
                <div class="dropdown mb-2 text-right">
                    ...
                    <button class="btn btn-sm  btn-primary btn-rounded" type="button" data-toggle="modal"
                            data-target="#addNewLead">@lang('Add New Lead')</button>
                            ...
                            <td data-label="@lang('Name')">
                                <a href="{{route('admin.user-edit',[$user->id])}}" target="_blank">
                                    <div class="d-flex no-block align-items-center">
                                        ...
                                        <div class="">
                                            <h5 class="text-dark mb-0 font-16 font-weight-medium">@lang($user->name)</h5>
                                        </div>
                                    </div>
                                </a>
                            </td>
                            <td data-label="@lang('Company')">@lang($user->company)</td>
                            <td data-label="@lang('Phone')">@lang($user->phone)</td>
                            <td data-label="@lang('Phone')">@lang($user->lead_value)</td>
                            <td data-label="@lang('Tags')">@lang($user->tags)</td>
                            <td data-label="@lang('Assigned')">@lang($user->assigned_user)</td>

                            <td data-label="@lang('Status')">
                                <span
                                    class="custom-badge badge-pill {{ $user->status == 0 ? 'bg-danger' : 'bg-success' }}">{{ $user->status == 0 ? 'Inactive' : 'Active' }}</span>
                            </td>
                                <td data-label="@lang('Source')">@lang($user->source)</td>
                                <td data-label="@lang('Created')">@lang($user->source)</td>
                                ...
                                <td data-label="@lang('Action')">
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a class="dropdown-item" onclick="editLead({{$user->id}})">
                                                <i class="fa fa-edit text-warning pr-2"
                                                   aria-hidden="true"></i> @lang('Edit')
                                            </a>
                                            <a class="dropdown-item" href="{{ route('admin.deleteLead',$user->id) }}">
    ...
    <div class="modal fade" id="editLead">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form method="post" id="editLeadForm" enctype="multipart/form-data">
                    @csrf
                    <!-- Modal Header -->
                    <div class="modal-header modal-colored-header bg-primary">
                        <h4 class="modal-title">@lang('Update Lead')</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-4">
                                <label>Source</label>
                                <select id="editSource" class="form-control  selectpicker currency-change"
                                        data-live-search="true" name="source"
                                        required="">
                                    <option disabled selected>Nothing Selected</option>
                                    <option value="1">New</option>
                            ...
                            <div class="form-group col-md-4 col-4">
                                <label>Assigned User</label>
                                <select id="editAssignedUser" class="form-control  selectpicker currency-change"
                                        data-live-search="true" name="assigned_user"
                                        required="">
                                    <option disabled selected>Nothing Selected</option>
                                    <option value="1">New</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-6">
                                <label>City</label>
                                <input id="editCity" type="text" class="form-control "
                                       name="city"
                                       value="{{ old('city') }}"  required="">
                                <div class="invalid-feedback">
                                    Please fill in the address
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-6">
                                <label>Email Address</label>
                                <input id="editEmailAddress" type="text" class="form-control "
                                       name="email_address"
                                       value="{{ old('email_address') }}"  required="">
                                <div class="invalid-feedback">
                                    Please fill in the email address
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-6">
                                <label>Website</label>
                                <input id="editWebsite" type="text" class="form-control "
                                       name="website"
                                       value="{{ old('website') }}"  required="">
                                <div class="invalid-feedback">
                                    Please fill in the website
                            ...
                            <div class="form-group col-md-6 col-6">
                                <label>Country</label>
                                <input id="editCountry" type="text" class="form-control "
                                       name="country"
                                       value="{{ old('country') }}"  required="">
                                <div class="invalid-feedback">
                                    Please fill in the country
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-6">
                                <label>Zip Code</label>
                                <input id="editZipCode" type="text" class="form-control "
                                       name="zip_code"
                                       value="{{ old('zip_code') }}"  required="">
                                <div class="invalid-feedback">
                                    Please fill in the zip code
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-6">
                                <label>Lead Value</label>
                                <input id="editLeadValue" type="text" class="form-control "
                                       name="lead_value"
                                       value="{{ old('lead_value') }}"  required="">
                                <div class="invalid-feedback">
                                    Please fill in the lead value
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-6">
                                <label>Company</label>
                                <input id="editCompany" type="text" class="form-control "
                                       name="company"
                                       value="{{ old('company') }}"  required="">
                                <div class="invalid-feedback">
                                    Please fill in the company
        ...
        function editLead(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#editSource').val(data.source).trigger('change')
                    $('#editAssignedUser').val(data.assigned_user_id).trigger('change')
                    ...
                    $('#editCountry').val(data.country_code)
                    $('#editEmailAddress').val(data.email)
                    $('#editWebsite').val(data.website)
                    $('#editPhone').val(data.phone)
                    $('#editZipCode').val(data.zip_code)
                    $('#editLeadValue').val(data.lead_value)
                    $('#editLanguage').val(data.language_id)
                    $('#editCompany').val(data.company)
                    $('#editDescription').val(data.description)
                    $('#editLeadForm').attr('action','update-lead/'+id);
