        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                @if(adminAccessRoute(config('role.dashboard.access.view')))
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('admin.documentation')}}" aria-expanded="false" target="_blank">
                            <i data-feather="book" class="feather-icon text-primary"></i>
                            <span class="hide-menu">@lang('Documentation')</span>
                        </a>
                    </li>
                @endif
                ...
                @if(adminAccessRoute(config('role.manage_property.access.view')))
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('admin.scheduleManage') }}" aria-expanded="false">
                            ...
                            <span class="hide-menu">@lang('Profit Return Schedule')</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item {{menuActive(['admin.propertyCreate'])}}">
                        ...
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{ route('admin.propertyList',['expired'])}}" aria-expanded="false">
                                    <span class="hide-menu">@lang('Expired Properties')</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @endif
                    ...
                    @if(adminAccessRoute(config('role.manage_user.access.view')))
                        {{--Manage User--}}
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">@lang('Sales')</span></li>

                        <li class="sidebar-item {{menuActive(['admin.proposals','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.proposals') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu">@lang('Proposals')</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{menuActive(['admin.estimates','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.estimates') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu">@lang('Estimates')</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{menuActive(['admin.invoices','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.invoices') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu">@lang('Invoices')</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{menuActive(['admin.items','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.items') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu">@lang('Items')</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{menuActive(['admin.contracts','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.contracts') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu">@lang('Contract')</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{menuActive(['admin.tasks','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.tasks') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                    ...
                    @if(adminAccessRoute(config('role.manage_user.access.view')))
                        {{--Manage User--}}
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">@lang('Manage Leads')</span></li>

                        <li class="sidebar-item {{menuActive(['admin.users','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.leads') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu">@lang('All Leads')</span>
                            </a>
                        </li>
                    ...
                    @if(adminAccessRoute(config('role.manage_user.access.view')))
                        {{--Manage User--}}
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">@lang('File Manager')</span></li>

                        <li class="sidebar-item {{menuActive(['admin.filemanager','admin.filemanager*'],3)}}">
                            <a class="sidebar-link" href="{{ route('admin.filemanager') }}" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu">@lang('File Manager')</span>
                            </a>
                        </li>
                ...
                @endif
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap text-center"><span class="hide-menu">@lang('Version 1.2')</span></li>
            </ul>
        </nav>
