        ...
        <div class="card-body">
            @if(adminAccessRoute(config('role.manage_user.access.edit')))
                <div class="dropdown mb-2 text-right">
                    ...
                    <a class="btn btn-sm  btn-primary btn-rounded" type="button" href="{{route('admin.createEstimate')}}"
                    >@lang('Add New Estimate')</a>
            ...
            <div class="table-responsive">
                        ...
                        <tr>
                            @if(adminAccessRoute(config('role.manage_user.access.edit')))
                                <td class="text-center">
                                    <input type="checkbox" id="chk-{{ $estimate->id }}"
                                           class="form-check-input row-tic tic-check" name="check" value="{{$estimate->id}}"
                                           data-id="{{ $estimate->id }}">
                                    <label for="chk-{{ $estimate->id }}"></label>
                                </td>
                            @endif
                            ...
                            <td data-label="@lang('Name')">
                                @lang($estimate->subtotal)
                            </td>
                            <td data-label="@lang('Company')">@lang($estimate->discount_type)</td>
                            <td data-label="@lang('Phone')">@lang($estimate->customer_id)</td>
                            <td data-label="@lang('Phone')">@lang($estimate->tags)</td>
                            <td data-label="@lang('Tags')">@lang($estimate->date)</td>
                            <td data-label="@lang('Assigned')">@lang($estimate->expiry_date)</td>
                            <td data-label="@lang('Assigned')">@lang($estimate->reference)</td>

                            <td data-label="@lang('Status')">
                                <span
                                    class="custom-badge badge-pill {{ $estimate->status == 0 ? 'bg-danger' : 'bg-success' }}">{{ $estimate->status == 0 ? 'Inactive' : 'Active' }}</span>
                            </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item" href="{{ route('admin.deleteEstimate',$estimate->id) }}">
                ...
                {{$estimates->appends(@$search)->links('partials.pagination')}}
