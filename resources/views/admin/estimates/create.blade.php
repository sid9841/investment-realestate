        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-12">
                ...
                <div class="card mb-4 shadow">
                    <div class="card-body">
                        @if(isset($estimate))
                            <form method="post" action="{{route('admin.updateEstimate',$estimate->id)}}" enctype="multipart/form-data">

                        @else
                            <form method="post" action="{{route('admin.storeEstimate')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12 col-12" >
                                            ...
                                            <select class="form-control  selectpicker currency-change"
                                                ...
                                                @foreach($customers as $customer)
                                                    <option value="{{$customer->id}}" {{@$estimate->customer_id == $customer->id ? 'selected' : ''}}>{{$customer->fullname}}</option>
                                        ...
                                        <div class="form-group col-md-6 col-6">
                                            ...
                                            <input type="date" class="form-control "
                                                   name="issue_date"
                                                   value="{{ isset($estimate) ? $estimate->date : old('issue_date') }}"  required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-6">
                                            ...
                                            <input type="date" class="form-control "
                                                   name="open_till_date"
                                                   value="{{ isset($estimate) ? $estimate->expiry_date : old('open_till_date') }}"  required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="number" class="form-control "
                                                   name="est_no"
                                                   value="{{ isset($estimate) ? $estimate->estimate_no : old('est_no') }}"  required="">
                                            <div class="invalid-feedback">
                                                Please fill in the est no
                                            </div>
                                            @if ($errors->has('est_no'))
                                                <span class="invalid-text">
                                                {{ $errors->first('est_no') }}
                                            </span>
                                            @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-6">
                                                ...
                                                <select class="form-control  selectpicker currency-change"
                                                        ...
                                                        required="">
                                                    <option readonly selected>Nothing Selected</option>
                                                    <option value="1" {{@$estimate->currency_id == '1' ? 'selected' : ''}}>AUD</option>
                                                    <option value="2" {{@$estimate->currency_id == '2' ? 'selected' : ''}}>EUR</option>
                                                    <option value="3" {{@$estimate->currency_id == '3' ? 'selected' : ''}}>GBP</option>
                                                    <option value="4" {{@$estimate->currency_id == '4' ? 'selected' : ''}}>USD</option>
                                                </select>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-12 col-12">
                                                ...
                                                <input type="text" class="form-control "
                                                       name="reference"
                                                       id="reference"
                                                       value="{{ isset($estimate) ? $estimate->reference : old('reference') }}"  required="">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-6 col-6">
                                                ...
                                                <select class="form-control  selectpicker currency-change"
                                                    ...
                                                    @foreach($admins as $admin)
                                                        <option {{@$estimate->agent_id == $admin->id ? 'selected' : ''}} value="{{$admin->id}}">{{$admin->name}}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-6 col-6">
                                                ...
                                                <select class="form-control  selectpicker currency-change"
                                                        ...
                                                        required="">
                                                    <option readonly selected>Nothing Selected</option>
                                                    <option {{@$estimate->discount_type == 'Before Tax' ? 'selected' : ''}} value="Before Tax">Before Tax</option>
                                                    <option {{@$estimate->discount_type == 'After Tax' ? 'selected' : ''}} value="After Tax">After Tax</option>
                                                </select>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-12 col-12">
                                                ...
                                                <textarea type="text" class="form-control "
                                                          name="admin_note"
                                                          id="admin_note"
                                                          required="">{{ isset($estimate) ? $estimate->admin_note : old('admin_note') }}</textarea>
                                                <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive s_table">
                                        <input type="hidden" name="estimateItems" value="{{json_encode(@$estimate->items)}}" id="estimateItems">
                                ...
                                <div class="col-md-8 offset-4">
                                    <table class="table text-right">
                                        ...
                                        <tr>
                                            ...
                                            <td class="subtotal" ><input type="text" value="{{@$estimate->subtotal}}" name="subtotal" readonly id="subtotal"></td>
                                        </tr>
                                        <tr id="discount_area">
                                            <td>
                                            ...
                                            <td class="discount-total">
                                                ...
                                                <input type="number" value="{{@$estimate->discount}}" class="" min="0"  id="discount_percent" name="discount_percent">
                                        ...
                                        <tr>
                                            ...
                                            <td class="total" ><input readonly value="{{@$estimate->subtotal - @$estimate->discount}}" type="text" id="total"></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <textarea type="text" class="form-control "
                                              name="client_note"
                                              id="client_note"
                                              required="">{{ isset($estimate) ? $estimate->client_note : old('client_note') }}</textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <textarea type="text" class="form-control "
                                              ...
                                              id="terms_conditions"
                                              required="">{{ isset($estimate) ? $estimate->terms_conditions : old('terms_conditions') }}</textarea>
                                    <div class="invalid-feedback">
