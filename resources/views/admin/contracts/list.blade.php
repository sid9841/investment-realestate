        ...
        <div class="card-body">
            @if(adminAccessRoute(config('role.manage_user.access.edit')))
                <div class="dropdown mb-2 text-right">
                    ...
                    <a class="btn btn-sm  btn-primary btn-rounded" type="button" href="{{route('admin.createContract')}}"
                    >@lang('Add New Contract')</a>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col">@lang('Contract Type')</th>
                        <th scope="col">@lang('Contract Value')</th>
                        ...
                        <tr>
                            @if(adminAccessRoute(config('role.manage_user.access.edit')))
                                <td class="text-center">
                                    <input type="checkbox" id="chk-{{ $contract->id }}"
                                           class="form-check-input row-tic tic-check" name="check" value="{{$contract->id}}"
                                           data-id="{{ $contract->id }}">
                                    <label for="chk-{{ $contract->id }}"></label>
                                </td>
                            @endif
                            <td data-label="@lang('No.')">
                                <a href="{{route('admin.user-edit',[$contract->id])}}" target="_blank">
                                    <div class="d-flex no-block align-items-center">

                                        <div class="">
                                {{loopIndex($contracts) + $loop->index}}
                                        </div>
                                    </div>
                                </a>
                            </td>

                            <td data-label="@lang('Company')">@lang($contract->subject)</td>
                            <td data-label="@lang('Phone')">@lang($contract->customer_id)</td>
                            <td data-label="@lang('Phone')">@lang($contract->type)</td>
                            <td data-label="@lang('Tags')">@lang($contract->contract_value)</td>
                            <td data-label="@lang('Assigned')">@lang($contract->start_date)</td>
                            <td data-label="@lang('Assigned')">@lang($contract->end_date)</td>

                            <td data-label="@lang('Status')">
                                <span
                                    class="custom-badge badge-pill {{ $contract->status == 0 ? 'bg-danger' : 'bg-success' }}">{{ $contract->status == 0 ? 'Inactive' : 'Active' }}</span>
                            </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item" href="{{ route('admin.deleteContract',$contract->id) }}">
                ...
                {{$contracts->appends(@$search)->links('partials.pagination')}}
