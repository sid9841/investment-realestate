        ...
        <div class="container h-100">
            <div class="row h-100 justify-content-center">
                <div class="col-lg-12">
                    ...
                    <span class="pp-infobox-title-prefix">Please Enter the referral code below to register.</span>
                    <div class="pp-infobox-title-wrapper">
                        <h3 class="pp-infobox-title">This platform is invite only.</h3>
                        <div class="text-center" style="width: 100%;">
                            <img src="{{ asset('assets/uploads/content/6486c88c2614c1686554764.png') }}" alt="" class="img-fluid" />
                        </div>
                    </div>
                    </div>
                    <form class="text-center" action="{{ route('registerReferral') }}" method="post">
                        @csrf
                        <div class="row g-4">
                        ...
                        <button class="btn-custom mt-2 mb-2" type="submit">@lang('sign up')</button>
                    </form>
