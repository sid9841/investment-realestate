            ...
            <div class="container">
                ...
                <div class="row g-lg-5">
                    <div class="col-lg-8">
                        ...
                        @if(0 < count($singlePropertyDetails->allamenity))
                        ...
                        @if($singlePropertyDetails->video)
                        <div id="amenities" class="video-box">
                            <h4 class="mb-4">@lang('Video')</h4>
                            <div class="row gy-4">
                                <iframe width="100%" height="100%"
                                        src="{{ $singlePropertyDetails->video }}"
                                        frameborder="0"
                        ...
                        @if($singlePropertyDetails->location)
                            ...
                            <form action="{{route('user.invest-property', $singlePropertyDetails->id)}}" method="post">
                                ...
                                <div class="side-box">
                                    ...
                                    <ul class="profit-calculation">
                                        ...
                                        <li>@lang('Profit'):
                                            <span>{{ $singlePropertyDetails->profit_type == 1 ? $singlePropertyDetails->profit.'%' : config('basic.currency_symbol').$singlePropertyDetails->profit }}</span>
                                        </li>
