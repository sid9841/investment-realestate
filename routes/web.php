...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin','permission']], function () {
        ...
        Route::get('/documentation', 'Admin\DashboardController@documentation')->name('documentation');
        ...
        /*===Manage Leads ====*/
        Route::get('/leads', 'Admin\LeadsController@index')->name('leads');
        Route::post('/create-lead', 'Admin\LeadsController@create')->name('createLead');
        Route::post('/getLeadInfo', 'Admin\LeadsController@getLeadInfo')->name('getLeadInfo');
        Route::post('/update-lead/{id}', 'Admin\LeadsController@update')->name('updateLead');
        Route::get('/delete-lead/{id}', 'Admin\LeadsController@destroy')->name('deleteLead');
        ...
        /*===Manage Items ====*/
        Route::get('/items', 'Admin\ItemsController@index')->name('items');
        Route::post('/create-item', 'Admin\ItemsController@create')->name('createItem');
        Route::post('/getItemInfo', 'Admin\ItemsController@getItemInfo')->name('getItemInfo');
        Route::post('/update-item/{id}', 'Admin\ItemsController@update')->name('updateItem');
        Route::get('/delete-item/{id}', 'Admin\ItemsController@destroy')->name('deleteItem');

        /*===Manage Contract ====*/
        Route::get('/contracts', 'Admin\ContractController@index')->name('contracts');
        ...
        /*===Manage Tasks ====*/
        Route::get('/tasks', 'Admin\TaskController@index')->name('tasks');
//        Route::get('/create-task', 'Admin\TaskController@create')->name('createTask');
        Route::post('/task-store', 'Admin\TaskController@store')->name('storeTask');
        Route::post('/getTaskInfo', 'Admin\TaskController@getTaskInfo')->name('getTaskInfo');
        Route::post('/update-task/{id}', 'Admin\TaskController@update')->name('updateTask');
        Route::get('/delete-task/{id}', 'Admin\TaskController@destroy')->name('deleteTask');
