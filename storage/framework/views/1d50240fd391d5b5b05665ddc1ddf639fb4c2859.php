<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get("Estimate List"); ?>
        ...
        <div class="card-body">
            <?php if(adminAccessRoute(config('role.manage_user.access.edit'))): ?>
                <div class="dropdown mb-2 text-right">
                    ...
                    <a class="btn btn-sm  btn-primary btn-rounded" type="button" href="<?php echo e(route('admin.createEstimate')); ?>"
                    ><?php echo app('translator')->get('Add New Estimate'); ?></a>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <?php endif; ?>
                        <th scope="col"><?php echo app('translator')->get('Estimate#'); ?></th>
                        ...
                        <th scope="col"><?php echo app('translator')->get('Expiry Date'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('Reference#'); ?></th>
                        ...
                        <tr>
                            <?php if(adminAccessRoute(config('role.manage_user.access.edit'))): ?>
                                <td class="text-center">
                                    <input type="checkbox" id="chk-<?php echo e($estimate->id); ?>"
                                           class="form-check-input row-tic tic-check" name="check" value="<?php echo e($estimate->id); ?>"
                                           data-id="<?php echo e($estimate->id); ?>">
                                    <label for="chk-<?php echo e($estimate->id); ?>"></label>
                                </td>
                            <?php endif; ?>
                            <td data-label="<?php echo app('translator')->get('No.'); ?>">
                                <a href="<?php echo e(route('admin.user-edit',[$estimate->id])); ?>" target="_blank">
                                    <div class="d-flex no-block align-items-center">

                                        <div class="">EST-<?php echo e($estimate->estimate_no); ?>
                            ...
                            <td data-label="<?php echo app('translator')->get('Name'); ?>">
                                <?php echo app('translator')->get($estimate->subtotal); ?>
                            </td>
                            <td data-label="<?php echo app('translator')->get('Company'); ?>"><?php echo app('translator')->get($estimate->discount_type); ?></td>
                            <td data-label="<?php echo app('translator')->get('Phone'); ?>"><?php echo app('translator')->get($estimate->customer_id); ?></td>
                            <td data-label="<?php echo app('translator')->get('Phone'); ?>"><?php echo app('translator')->get($estimate->tags); ?></td>
                            <td data-label="<?php echo app('translator')->get('Tags'); ?>"><?php echo app('translator')->get($estimate->date); ?></td>
                            <td data-label="<?php echo app('translator')->get('Assigned'); ?>"><?php echo app('translator')->get($estimate->expiry_date); ?></td>
                            <td data-label="<?php echo app('translator')->get('Assigned'); ?>"><?php echo app('translator')->get($estimate->reference); ?></td>

                            <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                <span
                                    class="custom-badge badge-pill <?php echo e($estimate->status == 0 ? 'bg-danger' : 'bg-success'); ?>"><?php echo e($estimate->status == 0 ? 'Inactive' : 'Active'); ?></span>
                            </td>
                                ...
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a class="dropdown-item" href="<?php echo e(route('admin.editEstimate',$estimate->id)); ?>">
                                                <i class="fa fa-edit text-warning pr-2"
                                                   aria-hidden="true"></i> <?php echo app('translator')->get('Edit'); ?>
                                            </a>
                                            <a class="dropdown-item" href="<?php echo e(route('admin.deleteEstimate',$estimate->id)); ?>">
                ...
                <?php echo e($estimates->appends(@$search)->links('partials.pagination')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/investment-realestate/resources/views/admin/estimates/list.blade.php ENDPATH**/ ?>