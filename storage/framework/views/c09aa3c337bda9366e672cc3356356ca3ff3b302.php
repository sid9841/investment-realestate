        ...
        <div class="plan d-flex justify-content-between">
            <div>
                <?php if($property->profit_type == 1): ?>
                    <h5><?php echo e(@$property->profit); ?>% (<?php echo app('translator')->get('Fixed'); ?>)</h5>
                <?php else: ?>
                    <h5><?php echo e(config('basic.currency_symbol')); ?><?php echo e(@$property->profit); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/investment-realestate/resources/views/themes/original/partials/propertyBox.blade.php ENDPATH**/ ?>