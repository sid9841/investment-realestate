<?php $__env->startSection('title'); ?>
    <?php if(isset($contract)): ?>
        <?php echo app('translator')->get("Edit Contract"); ?>

    <?php else: ?>

    <?php echo app('translator')->get("Create Contract"); ?>
    <?php endif; ?>
        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-12">
                ...
                <div class="card mb-4 shadow">
                    <div class="card-body">
                        <?php if(isset($contract)): ?>
                            <form method="post" action="<?php echo e(route('admin.updateContract',$contract->id)); ?>" enctype="multipart/form-data">

                        <?php else: ?>
                            <form method="post" action="<?php echo e(route('admin.storeContract')); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12 col-12" >
                                            ...
                                            <select class="form-control  selectpicker currency-change"
                                                ...
                                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($customer->id == @$contract->customer_id ? 'selected' : ''); ?> value="<?php echo e($customer->id); ?>"><?php echo e($customer->fullname); ?></option>
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="text" class="form-control "
                                                   name="subject"
                                                   value="<?php echo e(isset($contract) ? $contract->subject : old('subject')); ?>"  required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="text" class="form-control "
                                                   name="contract_value"
                                                   value="<?php echo e(isset($contract) ? $contract->contract_value : old('contract_value')); ?>"  required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-6">
                                            ...
                                            <input type="date" class="form-control "
                                                   name="issue_date"
                                                   value="<?php echo e(isset($contract) ? $contract->start_date :  old('issue_date')); ?>"  required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-6 col-6">
                                            ...
                                            <input type="date" class="form-control "
                                                   name="open_till_date"
                                                   value="<?php echo e(isset($contract) ? $contract->end_date : old('open_till_date')); ?>"  required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <textarea type="text" class="form-control "
                                                      name="description"
                                                      id="description"
                                                      required=""><?php echo e(isset($contract) ? $contract->description :  old('description')); ?></textarea>
                                            <div class="invalid-feedback">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/investment-realestate/resources/views/admin/contracts/create.blade.php ENDPATH**/ ?>