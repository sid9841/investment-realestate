        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <?php if(adminAccessRoute(config('role.dashboard.access.view'))): ?>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?php echo e(route('admin.documentation')); ?>" aria-expanded="false" target="_blank">
                            <i data-feather="book" class="feather-icon text-primary"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Documentation'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(adminAccessRoute(config('role.manage_property.access.view'))): ?>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?php echo e(route('admin.scheduleManage')); ?>" aria-expanded="false">
                            ...
                            <span class="hide-menu"><?php echo app('translator')->get('Profit Return Schedule'); ?></span>
                        </a>
                    </li>
                ...
                <?php endif; ?>
                    ...
                    <?php if(adminAccessRoute(config('role.manage_user.access.view'))): ?>
                        ...
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Sales'); ?></span></li>

                        <li class="sidebar-item <?php echo e(menuActive(['admin.proposals','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.proposals')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Proposals'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php echo e(menuActive(['admin.estimates','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.estimates')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Estimates'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php echo e(menuActive(['admin.invoices','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.invoices')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Invoices'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php echo e(menuActive(['admin.items','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.items')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Items'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php echo e(menuActive(['admin.contracts','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.contracts')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('Contract'); ?></span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php echo e(menuActive(['admin.tasks','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.tasks')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                    ...
                    <?php if(adminAccessRoute(config('role.manage_user.access.view'))): ?>
                        ...
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Manage Leads'); ?></span></li>

                        <li class="sidebar-item <?php echo e(menuActive(['admin.users','admin.users.search','admin.user-edit*','admin.send-email*','admin.user*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.leads')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('All Leads'); ?></span>
                            </a>
                        </li>
                    ...
                    <?php if(adminAccessRoute(config('role.manage_user.access.view'))): ?>
                        ...
                        <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('File Manager'); ?></span></li>

                        <li class="sidebar-item <?php echo e(menuActive(['admin.filemanager','admin.filemanager*'],3)); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('admin.filemanager')); ?>" aria-expanded="false">
                                <i class="fas fa-users text-info"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('File Manager'); ?></span>
                            </a>
                        </li>
                ...
                <?php endif; ?>
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap text-center"><span class="hide-menu"><?php echo app('translator')->get('Version 1.2'); ?></span></li>
            </ul>
        </nav>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/investment-realestate/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>