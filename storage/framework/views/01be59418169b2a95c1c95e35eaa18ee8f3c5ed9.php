<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get("Invoice List"); ?>
        ...
        <div class="card-body">
            <?php if(adminAccessRoute(config('role.manage_user.access.edit'))): ?>
                <div class="dropdown mb-2 text-right">
                    ...
                    <a class="btn btn-sm  btn-primary btn-rounded" type="button" href="<?php echo e(route('admin.createInvoice')); ?>"
                    ><?php echo app('translator')->get('Add New Invoice'); ?></a>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <?php endif; ?>
                        <th scope="col"><?php echo app('translator')->get('Invoice#'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('Amount'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('Discount Type'); ?></th>
                        ...
                        <tr>
                            <?php if(adminAccessRoute(config('role.manage_user.access.edit'))): ?>
                                <td class="text-center">
                                    <input type="checkbox" id="chk-<?php echo e($invoice->id); ?>"
                                           class="form-check-input row-tic tic-check" name="check" value="<?php echo e($invoice->id); ?>"
                                           data-id="<?php echo e($invoice->id); ?>">
                                    <label for="chk-<?php echo e($invoice->id); ?>"></label>
                                </td>
                            <?php endif; ?>
                            <td data-label="<?php echo app('translator')->get('No.'); ?>">
                                <a href="<?php echo e(route('admin.user-edit',[$invoice->id])); ?>" target="_blank">
                                    <div class="d-flex no-block align-items-center">

                                        <div class="">INV-<?php echo e(loopIndex($invoices) + $loop->index); ?>
                            ...
                            <td data-label="<?php echo app('translator')->get('Company'); ?>"><?php echo app('translator')->get($invoice->subtotal); ?></td>
                            <td data-label="<?php echo app('translator')->get('Phone'); ?>"><?php echo app('translator')->get($invoice->discount_type); ?></td>
                            <td data-label="<?php echo app('translator')->get('Phone'); ?>"><?php echo app('translator')->get($invoice->date); ?></td>
                            <td data-label="<?php echo app('translator')->get('Tags'); ?>"><?php echo app('translator')->get($invoice->customer_id); ?></td>
                            <td data-label="<?php echo app('translator')->get('Assigned'); ?>"><?php $__currentLoopData = $invoice->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo app('translator')->get($tag); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
                            <td data-label="<?php echo app('translator')->get('Assigned'); ?>"><?php echo app('translator')->get($invoice->due_date); ?></td>

                            <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                <span
                                    class="custom-badge badge-pill <?php echo e($invoice->status == 0 ? 'bg-danger' : 'bg-success'); ?>"><?php echo e($invoice->status == 0 ? 'Inactive' : 'Active'); ?></span>
                            </td>
                                ...
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a class="dropdown-item" href="<?php echo e(route('admin.editInvoice',$invoice->id)); ?>">
                                                <i class="fa fa-edit text-warning pr-2"
                                                   aria-hidden="true"></i> <?php echo app('translator')->get('Edit'); ?>
                                            </a>
                                            <a class="dropdown-item" href="<?php echo e(route('admin.deleteInvoice',$invoice->id)); ?>">
                ...
                <?php echo e($invoices->appends(@$search)->links('partials.pagination')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/investment-realestate/resources/views/admin/invoices/list.blade.php ENDPATH**/ ?>